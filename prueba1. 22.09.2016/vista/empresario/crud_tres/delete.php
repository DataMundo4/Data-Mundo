...
<div class="carousel slide"  id="mi" data-ride="carousel">
	...
	<div class="navbar navbar-inverse">
		<div class="container">
    		...
    		<div class="nav navbar-nav navbar-right">
   				<li><a href="?controlador=proyecto&accion=salir" class="btn btn-transparent btn btn-toggle"><span class="glyphicon glyphicon-log-out"></span> Cerrar Sesion</a></li>    		</div>
		</div>
	</div>
	<br>
    ...
    <div clas="container-fluid">
      <div class="panel panel-info">
        ...
        <form method="post" action="?controlador=Empresariotres&accion=eliminar">
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="text" name="puesto" class="form-control" placeholder="Ingrese el numero del puesto para eliminar el registro">
            </div>
            <hr>
