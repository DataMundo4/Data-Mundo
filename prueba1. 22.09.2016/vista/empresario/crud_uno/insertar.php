  ...
  <div class="col-md-4 col-md-offset-4">
    <div clas="container-fluid">
      <div class="panel panel-info">
        ...
        <form method="post" action="?controlador=empresario&accion=crud">
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="text" name="nombre" class="form-control" placeholder="Ingrese aqui sus Nombres">
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="text" name="apellido" class="form-control" placeholder="Ingrese aqui sus Apellidos">
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-ok"></span></span>
              <input type="text" name="cedula" class="form-control" placeholder="Ingrese aqui su Numero de Identificación">
            </div>
            <br>
            <div class="input-group">
            ...
            <div class="input-group">
              ...
              <input type="text" name="telefono" class="form-control" placeholder="Ingrese aqui su Numero de Telefono">
            </div>
            <hr>
