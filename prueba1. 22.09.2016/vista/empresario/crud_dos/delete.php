...
?>
    ...
    <div clas="container-fluid">
      <div class="panel panel-info">
        ...
        <form method="post" action="?controlador=Empresariodos&accion=eliminar">
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="text" name="numeropuesto" class="form-control" placeholder="Ingrese el numero del puesto para eliminar el registro">
            </div>
            <hr>
