      ...
      <div class="panel panel-info">
        ...
        <form method="post" action="?controlador=empresariocuatro&accion=crud">
            ...
            <div class="input-group">
              ...
              <input type="text" name="tiempodeuda" class="form-control" placeholder="Ingrese aqui el Tiempo de la deuda">
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-usd"></span></span>
              <input type="text" name="valordeuda" class="form-control" placeholder="Ingrese aqui el valor de la deuda">
            </div>
            <hr>
