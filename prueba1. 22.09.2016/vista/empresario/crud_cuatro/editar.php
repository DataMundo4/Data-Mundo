...
<div class="carousel slide"  id="mi" data-ride="carousel">
    ...
    <div clas="container-fluid">
      <div class="panel panel-info">
        ...
        <form method="post" action="?controlador=Empresariocuatro&accion=editar">
            <div class="input-group">
				<span class="input-group-addon"><span class="glyphicon glyphicon-ok"></span></span>
				<input type="text" name="ID_DEUDA" class="form-control" value=<?php echo $stmt['ID_DEUDA'];?> >
			</div>
			<br>
			<div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="number" name="numeropuesto" class="form-control" placeholder="Ingrese aqui su Numero de Puesto"  value=<?php echo $stmt['Numeropuesto']; ?>  >
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-user"></span></span>
              <input type="text" name="tiempodeuda" class="form-control" placeholder="Ingrese aqui el Tiempo de la Deuda" value=<?php echo $stmt['Tiempodeuda']; ?> >
            </div>
            <br>
            <div class="input-group">
              <span class="input-group-addon"><span class="glyphicon glyphicon-home"></span></span>
              <input type="text" name="valordeuda" class="form-control" placeholder="Ingrese aqui el Valor de la deuda" value=<?php echo $stmt['Valordeuda']; ?> >
            </div>
            <hr>
