...
<table class="table table-bordered table-hover">
  <tr class="active">
    <td><center>Id de la Deuda</center> </td>
    <td><center>Numero del Puesto</center> </td>
    <td><center>Tiempo de Deuda</center> </td>
    <td><center>Valor de la Deuda</center> </td>
  </tr>
  <tr class="active">
    <?php foreach ($stmt as $key) {
      ...
      ' <tr>
        ...
        <td>
				<form method="post" action="?controlador=empresariocuatro&accion=eliminar">
				<input type="hidden" name="deuda" value='.$key->ID_DEUDA.'>
				<button class="btn btn-info">Eliminar</button></form>
				</td>
				<td>
                <form method="post" action="?controlador=empresariocuatro&accion=crud">
				<input type="hidden" name="ID_DEUDA" value='.$key->ID_DEUDA.'>
