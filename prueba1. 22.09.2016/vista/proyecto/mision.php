...
<article>
				<h2>Misión:</h2>
				<p>Ser la mejor opción a la hora de satisfacer las necesidades de nuestros clientes en servicios de organización de información con la máxima seguridad y calidad. Ofrecer a nuestro equipo las mejores condiciones para su desarrollo integral en respuesta a su esfuerzo individual y grupal. 
 </p>
			
		</section>
		<aside  class="imagen col-md-4" >
			<h3><img src="img/mision.png" width="167" height="244" alt=""></h3>
			<p>&nbsp;</p>
		</aside>
	</section>
